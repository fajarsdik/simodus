...
if (empty($_SESSION['admin'])) {
    ...
    if ($id_user == 1) {
        ...
        if ($id_user == $_SESSION['id_user']) {
            echo '<script language="javascript">
                        window.alert("ERROR! Anda tidak diperbolehkan menghapus akun Anda sendiri. 
                        Hubungi super admin untuk menghapusnya");
                        window.location.href="./admin.php?page=usr";
                      </script>';
        } else {
            				        ...
            				        <table>
            				            ...
            				            <tbody>
            				                ...
            				                <tr>
            				                    ...
            				                    <td width="1%">:</td>';
                                                                if ($row['unit'] == 183) {
                                                                    $row_unit = 'Area Tanjungpinang';
                                                                } elseif ($row['unit'] == 18301) {
                                                                    $row_unit = 'Rayon Bintan Center';
                                                                } elseif ($row['unit'] == 18302) {
                                                                    $row_unit = 'Rayon Kijang';
                                                                } elseif ($row['unit'] == 18303) {
                                                                    $row_unit = 'Rayon Tg. Uban';
                                                                } elseif ($row['unit'] == 18304) {
                                                                    $row_unit = 'Rayon Belakang Padang';
                                                                } elseif ($row['unit'] == 18305) {
                                                                    $row_unit = 'Rayon Tg. Balai Karimun';
                                                                } elseif ($row['unit'] == 18306) {
                                                                    $row_unit = 'Rayon Tg. Batu';
                                                                } elseif ($row['unit'] == 18307) {
                                                                    $row_unit = 'Rayon Dabosingkep';
                                                                } elseif ($row['unit'] == 18308) {
                                                                    $row_unit = 'Rayon Natuna';
                                                                } elseif ($row['unit'] == 18309) {
                                                                    $row_unit = 'Rayon Tanjungpinang Kota';
                                                                } elseif ($row['unit'] == 18310) {
                                                                    $row_unit = 'Rayon Anambas';
                                                                }
                                                            } echo '
            				                    <td width="86%">' . $row_unit . '</td>
            				                </tr>
            				            </tbody>
            				   	</table>
    				            </div>
                                <div class="card-action">
            		                <a href="?page=usr&act=del&submit=yes&id_user=' .$row['id_user']. '" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	...
        	<!-- Row form END -->';
                ...
                if (isset($_REQUEST['submit'])) {
                    ...
                    if ($query == true) {
                        ...
                        echo '<script language="javascript">
                                    window.location.href="./admin.php?page=usr&act=del&id_user=' . $id_user . '";
                                  </script>';
                    }
                }
            }
