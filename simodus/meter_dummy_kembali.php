        ...
        if (isset($_REQUEST['act'])) {
                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=mdk" class="judul"><i class="material-icons">kitchen</i> Dummy Kembali</a></li>
            ...
            <div class="row jarak-form">
                ...
                if (isset($_REQUEST['submit'])) {
                    ...
                    echo '
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="10%">No. Dummy</th>
                                    <th width="10%">Stand Bongkar</th>
                                    <th width="10%">Tgl Kembali</th>
                                    <th width="15%">Lokasi Posko</th>
                                    <th width="18%">Nama Call Center</th>
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_metdum_kbl WHERE no_meter LIKE '%$cari%' || lokasi_posko LIKE '%$cari%'"
                            . "|| nama_cc LIKE '%$cari%'"
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_metdum_kbl ORDER by tgl_kbl DESC LIMIT $curr, $limit");
                    if (mysqli_num_rows($query) > 0) {
                        $no = 1;
                        while ($row = mysqli_fetch_array($query)) {
                            echo '
                        ...
                        echo '<tr><td colspan="5"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?page=mdk&act=add">Tambah data baru</a></u></p></center></td></tr>';
                    }
                    echo '</table>
                        </div>
                    </div>
