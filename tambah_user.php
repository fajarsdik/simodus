...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == ""  || $_REQUEST['unit'] == "" || $_REQUEST['admin'] == "") {
            ...
            if (!preg_match("/^[a-zA-Z0-9_]*$/", $username)) {
                ...
                if (!preg_match("/^[a-zA-Z., ]*$/", $nama)) {
                    ...
                    if (!preg_match("/^[a-zA-Z0-9_]*$/", $nip)) {
                        $_SESSION['nipuser'] = 'Form NIP hanya boleh mengandung karakter huruf, angka, spasi dan minus(-)';
                        echo '<script language="javascript">window.history.back();</script>';
                    } else {
                        ...
                        if ($result > 0) {
                            ...
                            if (strlen($username) < 5) {
                                ...
                                if (strlen($password) < 5) {
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_user(username, password, nama, nip, unit, admin) "
        ...
        <div class="row jarak-form">
            ...
            <!-- Form START -->
            <form class="col s12" method="post" action="?page=usr&act=add">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Jika tidak memiliki NIP, isi dengan minus(-)">
                    ...
                    <div class="input-field col s6">
                        <i class="material-icons prefix md-prefix">supervisor_account</i><label>Pilih Unit</label><br/>
                        <div class="input-field col s11 right">
                            <select class="browser-default validate" name="unit" id="unit" required>
                                <option value="183">Area Tanjungpinang</option>
                                <option value="18301">Rayon Bintan Center</option>
                                <option value="18302">Rayon Kijang</option>
                                <option value="18303">Rayon Tg. Uban</option>
                                <option value="18304">Rayon Belakang Padang</option>
                                <option value="18305">Rayon Tg. Balai Karimun</option>
                                <option value="18306">Rayon Tg. Batu</option>
                                <option value="18307">Rayon Dabosingkep</option>
                                <option value="18308">Rayon Natuna</option>
                                <option value="18309">Rayon Tanjungpinang Kota</option>
                                <option value="183010">Rayon Anambas</option>
                            </select>
                        </div>
                        <?php
                        if (isset($_SESSION['nipuser'])) {
